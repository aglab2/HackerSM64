COURSE_ACTS(COURSE_BOB, _(" 1 GOOMBA VALLEY"),
       _("EXPLORE THE CAVERNS...")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("AT THE END OF THE LAVA SOURCE")        , _("BEHIND CHAIN CHOMP'S GATE"))
