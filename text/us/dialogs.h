DEFINE_DIALOG(DIALOG_000,1,2,30,200, _("Welcome to a \n\
new world!"))
...
DEFINE_DIALOG(DIALOG_006,1,4,30,200, _("Mario, don't cheat on\n\
me! Come back later\n\
...
DEFINE_DIALOG(DIALOG_008,1,4,30,200, _("Thank you for\n\
downloading\n\
...
DEFINE_DIALOG(DIALOG_010,1,3,30,200, _("You've stepped on a cap \n\
switch. \n\
\n\
...
DEFINE_DIALOG(DIALOG_011,1,5,30,200, _("You've stepped on the \n\
Metal Cap switch!\n\
Now you can walk \n\
underwater, and you \n\
can't breathe. \n\
(Don't die now, you've \n\
still got stars to collect).\n\
Would you like to Save?\n\
\n\
//Yes////No"))

DEFINE_DIALOG(DIALOG_012,1,5,30,200, _("You've stepped on the \n\
...
DEFINE_DIALOG(DIALOG_015,1,5,30,200, _("Want to get that red \n\
coin? Is it out of \n\
reach for you?\n\
\n\
\n\
...
pressing [B]. \n\
You'll get up here much \n\
easier. Try this \n\
in other places, it may \n\
come in handy!!"))

DEFINE_DIALOG(DIALOG_016,1,4,30,200, _("It's horrible! Bowser \n\
came along and\n\
completely ruined these\n\
beautiful farmlands. \n\
...
DEFINE_DIALOG(DIALOG_017,1,5,30,200, _("I remember you. You threw \n\
...
DEFINE_DIALOG(DIALOG_018,1,6,30,200, _("Welcome to Calignous \n\
Cove. All around you \n\
is water. The best \n\
camera angle to use \n\
...
DEFINE_DIALOG(DIALOG_019,1,3,30,200, _("The coins of the switch\n\
hint at the key secrets,\n\
use it wisely."))
...
DEFINE_DIALOG(DIALOG_022,1,3,95,200, _("You can't open this\n\
door yet. Stop\n\
wasting your time."))
...
DEFINE_DIALOG(DIALOG_026,1,2,95,200, _("You can't open this door\n\
yet. Try another!"))

DEFINE_DIALOG(DIALOG_027,1,2,95,200, _("You can't open this door\n\
yet. Try another!"))

DEFINE_DIALOG(DIALOG_028,1,2,95,200, _("You can't open this door\n\
yet. Try another!"))

DEFINE_DIALOG(DIALOG_029,1,2,95,200, _("You can't open this door\n\
yet. Try another!"))

DEFINE_DIALOG(DIALOG_030,1,4,30,200, _("Whatever you do, do NOT\n\
touch the darker sand.\n\
It will engulf you\n\
straight away."))

DEFINE_DIALOG(DIALOG_031,1,4,30,200, _("You beat me Mario!\n\
...
DEFINE_DIALOG(DIALOG_032,1,3,30,200, _("WARNING!!! Jump down \n\
here, and there's no \n\
way back up.\n\
...
DEFINE_DIALOG(DIALOG_033,1,5,30,200, _("Whoa, you found the \n\
secret room!! I left \n\
behind a few 1-Hearts \n\
just for you!! \n\
\n\
...
DEFINE_DIALOG(DIALOG_034,1,5,30,200, _("Ancient Maze Entrance\n\
\n\
Bowser tasked me to\n\
hide a star in this maze\n\
and look after it.\n\
Who does he think I am?\n\
I'm but a tiny Goomba...\n\
and I'm scared of...\n\
mazes...\n\
\n\
Note to self, turn right\n\
wherever possible, else\n\
keep going straight.\n\
Only go left when there\n\
is no other option.\n\
Nobody will ever find my\n\
star, nobody ever reads\n\
signs! He he he..."))
...
DEFINE_DIALOG(DIALOG_036,1,6,30,200, _("Nice view up here,\n\
isn't it?\n\
Heyy wait a minute.\n\
...
DEFINE_DIALOG(DIALOG_039,1,5,30,200, _("Hey Mario!\n\
...
DEFINE_DIALOG(DIALOG_040,1,5,30,200, _("These keys you are\n\
looking for...\n\
\n\
\n\
\n\
...
DEFINE_DIALOG(DIALOG_042,1,5,30,200, _("This pipe over here leads\n\
to Bob-Omb Plains. \n\
\n\
\n\
\n\
The peaceful farmlands \n\
were turned into  \n\
Bob-omb turf, so \n\
watch your step when \n\
you enter the course!"))

DEFINE_DIALOG(DIALOG_043,1,3,30,200, _("It was a hard job \n\
...
DEFINE_DIALOG(DIALOG_048,1,5,30,200, _("You can get to Bowser \n\
through this door. \n\
Bowser locked the door \n\
though, so you need 15 \n\
stars to open it."))

DEFINE_DIALOG(DIALOG_049,1,2,30,200, _("This is MY bed! :D"))

DEFINE_DIALOG(DIALOG_050,1,2,30,200, _("The fireplace is warm. :)"))
...
DEFINE_DIALOG(DIALOG_052,1,4,30,200, _("Jump up to grab the\n\
...
DEFINE_DIALOG(DIALOG_054,1,5,30,200, _("Thank you so much,\n\
Mario!\n\
...
DEFINE_DIALOG(DIALOG_058,1,4,30,200, _("Thank you so much, \n\
Mario! You found my \n\
baby. Where was she? \n\
\n\
Oh, on a mountain's \n\
...
DEFINE_DIALOG(DIALOG_060,1,5,30,200, _("Why are you reading\n\
...
DEFINE_DIALOG(DIALOG_062,1,4,30,200, _("Welcome to the \n\
...
DEFINE_DIALOG(DIALOG_065,1,3,30,200, _("The water around our\n\
temple has all \n\
dried up..."))
...
DEFINE_DIALOG(DIALOG_067,1,4,30,200, _("Who's there...\n\
\n\
\n\
\n\
MARIO???? How in the\n\
...
DEFINE_DIALOG(DIALOG_068,1,4,30,200, _("Just ahead of you is\n\
a giant Mario!\n\
\n\
\n\
You must be warned\n\
...
DEFINE_DIALOG(DIALOG_069,1,4,30,200, _("Hi Mario!!!!!!\n\
Captain Toad here!\n\
...
DEFINE_DIALOG(DIALOG_070,1,4,30,200, _("I like the carpet in\n\
this castle, but it\n\
will never beat our\n\
Princess's castle."))

DEFINE_DIALOG(DIALOG_071,1,5,30,200, _("This is it Mario.\n\
...
DEFINE_DIALOG(DIALOG_072,1,3,30,200, _("I WISH I WAS TALLER!\n\
I WANT TO JUMP INTO\n\
THE MINECART!"))

DEFINE_DIALOG(DIALOG_073,1,3,95,200, _("This is Bowser's Castle.\n\
...
DEFINE_DIALOG(DIALOG_078,1,2,30,200, _("ELEVATOR OUT OF ORDER\n\
"))

DEFINE_DIALOG(DIALOG_079,1,6,30,200, _("Owwwuu! Let me go!\n\
...
DEFINE_DIALOG(DIALOG_081,1,3,30,200, _("EMERGENCY EXIT\n\
\n\
USE ONLY IF NEEDED"))
...
looking for stars \n\
right? \n\
Well, I found one on the\n\
way here, and I didn't \n\
know where you were. \n\
You can have it!"))
...
DEFINE_DIALOG(DIALOG_085,1,2,30,200, _("Great job Mario!"))

DEFINE_DIALOG(DIALOG_086,1,4,30,200, _("You certainly defeated\n\
Bowser this time! I had\n\
faith in you the whole\n\
time."))

DEFINE_DIALOG(DIALOG_087,1,2,30,200, _("YAAAAYYYYYYY MARIO!!"))

DEFINE_DIALOG(DIALOG_088,1,3,30,200, _("Go on and collect the\n\
star Bowser dropped.\n\
\n\
You've earned it!!!"))

DEFINE_DIALOG(DIALOG_089,1,2,95,200, _("Thanks for everything\n\
Mario! You rock!!!"))

DEFINE_DIALOG(DIALOG_090,1,3,30,200, _("The coins are \n\
quite suspicious. Try\n\
grabbing them..."))

DEFINE_DIALOG(DIALOG_091,2,3,30,200, _("WARNING!\n\
...
DEFINE_DIALOG(DIALOG_092,1,4,30,200, _("Mario!? Trying to chase\n\
me down or somethin'?\n\
\n\
\n\
Pfft, I'd love to see\n\
you try. I bet you can't \n\
defeat me, now that I've\n\
made the stage harder!\n\
COME AT ME YOO!!!"))

DEFINE_DIALOG(DIALOG_093,1,6,30,200, _("You back again so soon\n\
...
DEFINE_DIALOG(DIALOG_094,1,2,30,200, _("This door requires 20\n\
stars to open."))

DEFINE_DIALOG(DIALOG_095,1,2,30,200, _("This door requires 30\n\
stars to open."))

DEFINE_DIALOG(DIALOG_096,1,2,30,200, _("This door requires 40\n\
stars to open."))
...
\n\
\n\
If you switch to Lakitu\n\
perspective ([C]), it \n\
will make the camera so\n\
that it doesn't jump\n\
around everywhere.\n\
When trying to get up\n\
the waterfall, try and\n\
move Mario to gain \n\
height while wearing\n\
the Metal Cap."))

DEFINE_DIALOG(DIALOG_103,1,2,95,200, _("This door opens at\n\
4 stars."))
...
DEFINE_DIALOG(DIALOG_108,1,3,95,200, _("Boooooo-m! Here comes\n\
...
DEFINE_DIALOG(DIALOG_116,1,6,95,200, _("NOOOOO!! You're mean!\n\
...
DEFINE_DIALOG(DIALOG_119,1,4,30,200, _("Hmmm, that didn't go\n\
to plan. Raising the\n\
bombs did not \n\
work at all.\n\
You win Mario, but\n\
...
DEFINE_DIALOG(DIALOG_120,1,5,30,200, _("How in the world...\n\
\n\
\n\
\n\
\n\
...
DEFINE_DIALOG(DIALOG_121,1,5,30,200, _("NOOOOOOOOOOOOOO!!!\n\
...
DEFINE_DIALOG(DIALOG_125,1,6,30,200, _("There are TWO stars\n\
in this level, even if\n\
star radar says\n\
otherwise. I guess you\n\
would have figured\n\
this out anyways.\n\
On an unrelated note,\n\
credits for implementing\n\
the star radar in this\n\
game go to Kaze!"))
...
DEFINE_DIALOG(DIALOG_141,1,3,150,200, _("Horray! Your first \n\
star!! Keep up the \n\
good work."))

DEFINE_DIALOG(DIALOG_142,1,4,150,200, _("3 stars already? Great \n\
work! You only need 2 \n\
more stars to unlock \n\
the Toad's House!"))

DEFINE_DIALOG(DIALOG_143,1,4,150,200, _("Great work on getting \n\
...
DEFINE_DIALOG(DIALOG_146,1,4,150,200, _("Incredible! You just\n\
retrieved your 70th\n\
...
DEFINE_DIALOG(DIALOG_151,1,3,30,200, _("HEY, don't jump on me\n\
you little plumber.\n\
\n\
...
DEFINE_DIALOG(DIALOG_152,1,4,30,200, _("Okay, okay! Quit\n\
jumping on me Mario.\n\
\n\
\n\
I'll hand you this\n\
...
I'm sorry, but I \n\
haven't found any \n\
others. I've tried hard!"))

DEFINE_DIALOG(DIALOG_155,1,4,30,200, _("I gave you the star\n\
already. I just love\n\
to watch you climb \n\
that pole! \n\
Now, how do I get down?"))

DEFINE_DIALOG(DIALOG_156,1,4,30,200, _("I should really try\n\
...
DEFINE_DIALOG(DIALOG_163,1,6,30,200, _("NOOOOOOOOOOOOOOO!!!!!!!\n\
\n\
You've beaten me, Mario.\n\
How could I not have\n\
planned for this \n\
...
DEFINE_DIALOG(DIALOG_168,1,3,30,200, _("Ohh now you're asking\n\
for it. YOU SHALL BE\n\
SQUISHED NOW!!"))
