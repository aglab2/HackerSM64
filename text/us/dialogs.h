...
These are friendly boos!\n\
You can hop on them if\n\
...
Platforms here are sticky!\n\
You keep your position on\n\
them after the wallkick."))
...
DEFINE_DIALOG(DIALOG_060, 1, 1, 30, 200, _("\
Press L to reroll"))
...
DEFINE_DIALOG(DIALOG_097, 1, 1, 30, 200, _("\
Don't panic jump!"))
...
Try to recreate the star!\n\
Your current drawing is\n\
[%] percent accurate."))
...
DEFINE_DIALOG(DIALOG_156, 1, 2, 30, 200, _("\
The star's all yours!\n\
Go ahead!"))
