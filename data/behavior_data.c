...
extern void bhv_king_bobomb_init();
...
const BehaviorScript bhvKingBobombFaker[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, king_bobomb_seg5_anims_0500FE30),
    SET_INT(oInteractType, INTERACT_GRABBABLE),
...
extern void bhv_tree_init(void);
...
extern void bhv_bobomb_fight_ctl_init();
extern void bhv_bobomb_fight_ctl_loop();
const BehaviorScript bhvKingBobombCtl[] = {
    BEGIN(OBJ_LIST_LEVEL),
...
extern void bhv_wall_ctl_loop();
const BehaviorScript bhvWallCtl[] = {
    BEGIN(OBJ_LIST_LEVEL),
    BEGIN_LOOP(),
...
extern void bhv_motos_hand_loop();
