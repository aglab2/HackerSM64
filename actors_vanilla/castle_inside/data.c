...
#include "actors_vanilla/castle_inside/texture.inc.c"

#include "actors_vanilla/castle_inside/trap_door/model.inc.c"
#include "actors_vanilla/castle_inside/star_door/model.inc.c"
#include "actors_vanilla/castle_inside/pendulum/model.inc.c"
