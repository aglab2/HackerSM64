...
DECLARE_SEGMENT(ow_skybox_yay0)
DECLARE_SEGMENT(c4_skybox_yay0)
DECLARE_SEGMENT(c15_skybox_yay0)
DECLARE_SEGMENT(slide_skybox_yay0)
...
DECLARE_SEGMENT(ow_skybox_mio0)
DECLARE_SEGMENT(c4_skybox_mio0)
DECLARE_SEGMENT(c15_skybox_mio0)
DECLARE_SEGMENT(slide_skybox_mio0)
