...
enum RenderLayers {
    ...
    LAYER_TRANSPARENT,
    // For convenience layers are inverted
    // We draw in the inverted order compared to a regular
    LAYER_TRANSPARENT_PRE6,
    LAYER_TRANSPARENT_PRE5,
    LAYER_TRANSPARENT_PRE4,
    LAYER_TRANSPARENT_PRE3,
    LAYER_TRANSPARENT_PRE2,
    LAYER_TRANSPARENT_PRE1,
    LAYER_RED_FLAME,
    LAYER_BLUE_FLAME,
