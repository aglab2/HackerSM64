...
//model
#define MODEL_ROVERT_FLUXPOOL 0xFF
#define MODEL_ROVERT_PUSHABLE 0xFE
#define MODEL_ROVERT_GEAR1 0xFD
#define MODEL_ROVERT_GEAR2 0xFC
#define MODEL_ROVERT_HYPERBLOCK 0xFB
#define MODEL_ROVERT_GATE 0xFA
#define MODEL_ROVERT_BIGBALL 0xF9
