...
#define SOUND_AGLAB_OFFSET 0x3c

#define SOUND_AGLAB_CASTLE          SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x00, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_CASTLE2         SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x01, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_SURROUNDINGS    SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x02, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA1           SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x03, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA2           SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x04, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BG              SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x05, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BOWSER          SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x06, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BRIDGE          SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x07, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_DONE            SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x08, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_JAMS_DISASTER   SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x09, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_JAMS_DONE       SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x0a, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_JAMS_DUALITY    SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x0b, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_JAMS_EVOLUTION  SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x0c, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_JAMS_ONE        SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x0d, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_JAMS_SHELL      SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x0e, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_JAM0            SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x0f, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_MAIN            SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x10, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_MOAT            SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x11, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_PEACH           SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x12, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_PORTRAIT        SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x13, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_ROOF            SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x14, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_SIDETOWERS      SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x15, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_WALLS           SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x16, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_WINDOW          SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x17, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_RANDO           SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x18, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_AGLAB_BETA_OO         SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x19, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_YOW        SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x1a, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_OU         SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x1b, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_YAHHA      SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x1c, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_HAUGH      SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x1d, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_HOO        SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x1e, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_HOO2       SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x1f, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_HUAH       SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x20, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_BETA_NO         SOUND_ARG_LOAD(SOUND_BANK_MENU, SOUND_AGLAB_OFFSET + 0x21, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
