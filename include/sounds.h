...
#define SOUND_AGLAB_CASTLE  SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x76, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_CASTLE2 SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x77, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_AGLAB_SURROUNDINGS SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x78, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
