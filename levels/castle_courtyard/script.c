...
const LevelScript level_castle_courtyard_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(0xf3, gate20_geo), 
	...
	AREA(1, castle_courtyard_area_1),
		...
		OBJECT(0xf3, 7952, -1361, -7396, 0, 0, 0, 0x00000000, bhvGate20),
		OBJECT(MODEL_NONE, -15599, -2797, 8579, 0, 90, 0, (0xf1 << 16), bhvDeathWarp),
		MARIO_POS(0x01, 0, 10014, -2578, -6805),
		...
		OBJECT(MODEL_NONE, -6059, -2283, -9436, 0, -180, 0, (0x22 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -6064, -2284, -9435, 0, -180, 0, (0x21 << 16), bhvAirborneStarCollectWarp),
