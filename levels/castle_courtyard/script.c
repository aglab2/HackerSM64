...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(1, castle_courtyard_area_1),
		...
		PAINTING_WARP_NODE(0, LEVEL_VCUTM, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		PAINTING_WARP_NODE(1, LEVEL_VCUTM, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		PAINTING_WARP_NODE(2, LEVEL_VCUTM, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_THI_WARP_PIPE, 5529, -2904, 11777, 0, 90, 0, (0xc << 16), bhvWarpPipe),
		...
		OBJECT_WITH_ACTS(MODEL_1UP, -6245, -2380, -9695, 0, 90, 0, 0x00000000, bhv1Up, 0),
		OBJECT_WITH_ACTS(MODEL_1UP, -5856, -1994, -9695, 0, 90, 0, 0x00000000, bhv1Up, 0),
