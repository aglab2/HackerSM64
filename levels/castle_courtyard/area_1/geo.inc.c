...
const GeoLayout castle_courtyard_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_courtyard_dl___mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 0, -1483, -1639, 90, 0, 0, castle_courtyard_dl_epi_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
