...
const GeoLayout castle_courtyard_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 0, 1150, castle_courtyard_dl_letters_002_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_courtyard_dl_Plane_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_courtyard_dl_Plane_007_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
