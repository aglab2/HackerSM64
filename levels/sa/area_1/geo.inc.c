...
const GeoLayout sa_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, sa_dl_DL_sa_1_0xe02e610_Obj_mesh_layer_1),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, sa_dl_DL_sa_1_0xe035a68_Obj_mesh_layer_4),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, sa_dl_DL_sa_1_0xe035f18_Obj_mesh_layer_4),
