...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_NONE, 5070, 169, 1185, 0, 0, 0, (0x32 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 5215, -64, 1643, 0, 0, 0, 0x00000000, bhvOWCtl2),
		OBJECT(MODEL_NONE, 5225, 169, -1120, 0, 0, 0, (0x33 << 16), bhvDeathWarp),
		...
		OBJECT(MODEL_THI_WARP_PIPE, 5012, -64, 1293, 0, 0, 0, (0x12 << 16), bhvWarpPipe),
		OBJECT(MODEL_THI_WARP_PIPE, 5167, -64, -1012, 0, 0, 0, (0x13 << 16), bhvWarpPipe),
		...
		OBJECT(MODEL_NONE, 5068, 171, 1188, 0, 0, 0, (0x22 << 16), bhvAirborneStarCollectWarp),
		OBJECT(MODEL_NONE, 5223, 171, -1117, 0, 0, 0, (0x23 << 16), bhvAirborneStarCollectWarp),
