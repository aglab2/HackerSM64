...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_NONE, -1736, 2236, -624, 0, 90, 0, (11 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -1742, 2636, -17, 0, 90, 0, (11 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -1750, 3036, 594, 0, 90, 0, (11 << 16), bhvCoinFormation),
		...
		MARIO_POS(0x01, 0, -41, 4800, 1233),
		OBJECT(MODEL_PENGUIN, -2149, -63, -9, 0, 0, 0, 0x00000000, bhvSmallPenguin),
		OBJECT(MODEL_NONE, -307, -144, 3196, 0, 0, 0, (EXCLAMATION_BOX_BP_STAR_1 << 16), bhvExclamationBox),
