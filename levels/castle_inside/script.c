...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_MR_I, 3156, -323, -226, 0, 0, 0, 0x00000000, bhvMrI),
		OBJECT(MODEL_MR_I, -6784, 165, 593, 0, 0, 0, 0x00000000, bhvMrI),
		MARIO_POS(0x01, 0, -6839, 165, 3163),
	...
	AREA(2, castle_inside_area_2),
		...
		OBJECT(MODEL_NONE, 296, -3427, -583, 0, 90, 0, (0x32 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 3335, -2629, -6393, 0, 90, 0, (0xf1 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, 436, -3382, -614, 0, 90, 0, (0x31 << 16), bhvAirborneStarCollectWarp),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_METAL_DOOR, 4604, -5240, 12693, 0, -180, 0, (-21 << 24) | (0xa0 << 16), bhvDoorWarp),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_METAL_DOOR, 4467, -5240, 12691, 0, 0, 0, (-21 << 24) | (0xa1 << 16), bhvDoorWarp),
	...
	AREA(4, castle_inside_area_4),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE, 3, 0xf0, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE, 3, 0xf1, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 1640, -1073, -550, 0, 89, 0, (130 << 16), bhvDddMovingPole),
		OBJECT(MODEL_NONE, 1640, 19, -550, 0, 0, 0, (0xa << 16), bhvWarp),
