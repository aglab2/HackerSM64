...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0xf3, LEVEL_CASTLE, 0x01, 0x41, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 6721, -490, -200, 0, 90, 0, (0x41 << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -6784, 165, 3540, 0, 0, 0, (0xf1 << 16), bhvDeathWarp),
	...
	AREA(4, castle_inside_area_4),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE, 3, 0xf0, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE, 3, 0xf1, WARP_NO_CHECKPOINT),
		WARP_NODE(130, LEVEL_CASTLE, 3, 0xa0, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -199, 93, 150, 0, 87, 0, (0xa << 16), bhvWarp),
		OBJECT(MODEL_TOAD, 1279, 111, 83, 0, 87, 0, (83 << 24), bhvToadMessage),
		OBJECT(MODEL_NONE, -287, -141, 136, 0, 89, 0, (10 << 24) | (130 << 16), bhvWarp),
