...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		WARP_NODE(0x14, LEVEL_DAN, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x24, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x34, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x15, LEVEL_SPHERE, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 4974, 125, -5903, 0, 0, 0, (0x34 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -6260, 262, 634, 0, 0, 0, (0x35 << 16), bhvDeathWarp),
		...
		OBJECT(MODEL_NONE, 4959, -238, -5527, 0, 0, 0, (0x14 << 16), bhvFadingWarp),
		OBJECT(MODEL_NONE, -6243, -64, 1004, 0, 0, 0, (0x15 << 16), bhvFadingWarp),
