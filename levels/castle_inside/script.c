...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, -3125, 3000, 7, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(MODEL_PURPLE_SWITCH, -1351, 3200, -23, 0, 0, 0, 0x00000000, bhvPurpleSwitchHiddenBoxes),
		...
		OBJECT(MODEL_NONE, -3125, 3083, 7, 0, 0, 0, (21 << 16), bhvFadingWarp),
		...
		OBJECT(MODEL_NONE, -307, -92, 3196, 0, 0, 0, (EXCLAMATION_BOX_BP_STAR_1 << 16), bhvExclamationBox),
