...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(212, 960, 160, 1073, 0, 0, 0, 0x00000000, bhv1Up),
		...
		OBJECT(187, 1307, 510, 141, 90, 36, 0, 0x00000000, bhvPenguinRaceShortcutCheck),
		...
		OBJECT(221, -1361, 1273, 880, 0, 90, 0, (82 << 16), bhvToadMessage),
		OBJECT(221, -332, -10, -220, 0, 167, 0, (133 << 24), bhvToadMessage),
		OBJECT(24, 928, 16, -1182, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, 1419, 1006, 1523, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, -1434, 45, -755, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(25, 994, 456, 840, 0, -180, 0, 0x00000000, bhvTree),
		OBJECT(25, 1179, 212, -437, 0, -180, 0, 0x00000000, bhvTree),
	...
	AREA(2, castle_inside_area_2),
		...
		OBJECT(212, 1063, -503, 1338, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(212, 1666, -503, 1338, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(212, 1370, -503, 1638, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(212, 1370, -503, 1031, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(34, -1854, -232, 432, 0, 0, 0, (64 << 24), bhvDoor),
		OBJECT(207, -1764, 1342, 1586, 0, 0, 0, 0x00000000, bhvFloorSwitchHiddenObjects),
		OBJECT(129, -1490, 1142, 1587, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(129, -1290, 1142, 1587, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(129, -1090, 1142, 1587, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(129, -200, 1142, 1587, 0, 0, 0, 0x00000000, bhvHiddenObject),
		OBJECT(129, 0, 1142, 1587, 0, 0, 0, 0x00000000, bhvHiddenObject),
		...
		OBJECT(187, -1416, 71, -1032, 90, 0, 0, 0x00000000, bhvPenguinRaceShortcutCheck),
		OBJECT(120, 802, 66, -291, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(120, -1852, -172, 569, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		...
		OBJECT(24, 1458, 90, -1529, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, 1635, 34, -1007, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, -1908, 34, -1514, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, -2172, 45, -968, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, -136, 0, -1410, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, -340, 0, -277, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(24, -1157, 43, -1534, 0, 0, 0, 0x00000000, bhvTree),
