...
const GeoLayout castle_inside_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE_INTER, 5509, -3561, -433, castle_inside_dl_ow1_003_mesh_layer_3),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, castle_inside_dl_ow1_003_mesh_layer_2),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_ow1_003_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_ALPHA, castle_inside_dl_ow1_003_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 5509, -3561, -433, castle_inside_dl_ow1_008_mesh_layer_1),
		GEO_ASM(0, geo_painting_update),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -800, -1886, -151),
		GEO_ASM(PAINTING_ID(3, 1), geo_painting_draw),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -307, -3788, -649),
		GEO_ASM(PAINTING_ID(4, 1), geo_painting_draw),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 8154, -4074, 4709),
		GEO_ASM(PAINTING_ID(5, 1), geo_painting_draw),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 2956, -5002, 9106),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout castle_inside_area_2[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE_INTER, castle_inside_dl_material_revert_render_settings),
