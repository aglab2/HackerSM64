...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		MARIO_POS(0x01, 0, -5173, -1551, 8749),
		...
		OBJECT(MODEL_PIRANHA_PLANT, 7160, -1551, 12016, 0, -22, 0, 0x00000000, bhvPiranhaPlant),
		OBJECT(MODEL_PIRANHA_PLANT, 7425, -1551, 9552, 0, -22, 0, 0x00000000, bhvPiranhaPlant),
