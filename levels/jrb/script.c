...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		WARP_NODE(0xf3, LEVEL_JRB, 1, 0x41, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_BLARGG, 5554, -1551 + 20, -1663, 0, 0, 0, 0, bhvBlarrg),
		...
		OBJECT(MODEL_LLL_TILTING_SQUARE_PLATFORM, -12574, -936, 7128, 0, 0, 0, 0x00000000, bhvLllTiltingInvertedPyramid),
	...
	AREA(3, jrb_area_3),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE, 2, 0x31, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_JRB, 1, 0x42, WARP_NO_CHECKPOINT),
