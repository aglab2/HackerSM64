...
const GeoLayout jrb_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -4197, 913, -1097, jrb_dl_c3_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, -4197, 913, -1097, jrb_dl_c3_004_mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -4197, 913, -1097, 90, 0, 0, jrb_dl_zgrass_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -4197, 913, -1097, jrb_dl_zhflower_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -4197, 913, -1097, jrb_dl_zzthing_mesh_layer_1),
		GEO_OPEN_NODE(),
