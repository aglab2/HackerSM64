...
const GeoLayout jrb_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -4197, 913, -1097, 90, 0, 0, jrb_dl__hflower_mesh_layer_1),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -4197, 913, -1097, 90, 0, 0),
		GEO_OPEN_NODE(),
			GEO_CULL(-7000, 20000, -20000, 20000, -1600, 20000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, jrb_dl_b0_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -4197, 913, -1097, 90, 0, 0),
		GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, jrb_dl_b2_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -4197, 913, -1097, 90, 0, 0),
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, jrb_dl_b3_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -4197, 913, -1097, 90, 0, 0),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -4197, 913, -1097, 90, 0, 0),
