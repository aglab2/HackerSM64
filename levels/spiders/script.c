...
const LevelScript level_spiders_entry[] = {
	...
	AREA(1, spiders_area_1),
		OBJECT(MODEL_NONE, -9061, 654, 6183, 0, 71, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -4130, 1367, 7018, 0, 59, 0, 0x00000000, bhvCoinFormation),
		MARIO_POS(0x01, 0, 4376, 170, -8686),
		...
		OBJECT(MODEL_SPIDERS_BEE_BLUE, -9890, 1190, 4697, 0, -29, 0, 0x00000000, bhvSpidersHawk),
		...
		OBJECT(MODEL_SPIDERS_GATE, 8256, 0, 3757, 0, 39, 0, 0x00000000, bhvSpidersCage),
		OBJECT(MODEL_SPIDERS_BEE_BLUE, 8247, 0, 3505, 0, -51, 0, 0x00000000, bhvSpidersBuddy),
		...
		OBJECT(MODEL_NONE, 9153, 3921, 2714, 0, -80, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, -10114, 1059, 5328, 0, -59, 0, (6 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 9164, 4550, 2722, 0, -59, 0, (6 << 16), bhvExclamationBox),
		OBJECT(MODEL_NONE, 9973, 855, 2986, 0, -114, 0, (36 << 24) | (36 << 16), bhvFireSpitter),
		OBJECT(MODEL_NONE, 10039, 1015, 2595, 0, -114, 0, (36 << 24) | (36 << 16), bhvFireSpitter),
		OBJECT(MODEL_NONE, 10051, 626, 2598, 0, -114, 0, (36 << 24) | (36 << 16), bhvFireSpitter),
		OBJECT(MODEL_NONE, 9860, 1742, 3369, 0, -114, 0, (36 << 24) | (36 << 16), bhvFireSpitter),
		OBJECT(MODEL_NONE, 9845, 2333, 2791, 0, -114, 0, (36 << 24) | (36 << 16), bhvFireSpitter),
		OBJECT(MODEL_NONE, 9941, 2012, 3031, 0, -114, 0, (36 << 24) | (36 << 16), bhvFireSpitter),
		OBJECT(MODEL_NONE, 9648, 2630, 1864, 0, -114, 0, (36 << 24) | (36 << 16), bhvFireSpitter),
		...
		OBJECT(MODEL_SPIDERS_BEE_BLUE, -6793, -69, -8680, 0, -61, 0, (2 << 16), bhvSpidersHawk),
		OBJECT(MODEL_SPIDERS_BEE_BLUE, -5088, 1262, -5052, 0, -114, 0, (3 << 16), bhvSpidersHawk),
		...
		OBJECT(MODEL_SPIDERS_BEE_BLUE, -3705, 0, -3298, 0, -29, 0, (1 << 16), bhvSpidersHawk),
		...
		OBJECT(MODEL_NONE, -4233, 1744, -6196, 0, 31, 0, (3 << 24), bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -5769, 1509, -5464, 0, 31, 0, (3 << 24), bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -5856, 2334, -5464, 0, 31, 0, (3 << 24), bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -6326, 1520, -6281, 0, 31, 0, (3 << 24), bhvHiddenStarTrigger),
		OBJECT(MODEL_NONE, -5068, 2386, -6966, 0, 31, 0, (3 << 24), bhvHiddenStarTrigger),
