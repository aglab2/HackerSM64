...
const GeoLayout spiders_bee_angy_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_ALPHA, spiders_bee_angy_waterfally_bee_angy_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, spiders_bee_angy_material_revert_render_settings),
		GEO_DISPLAY_LIST(LAYER_ALPHA, spiders_bee_angy_material_revert_render_settings),
	GEO_CLOSE_NODE(),
	GEO_END(),
};
