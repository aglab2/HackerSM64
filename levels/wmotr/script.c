...
const LevelScript level_wmotr_entry[] = {
	...
	AREA(1, wmotr_area_1),
		...
		OBJECT(MODEL_BLUE_COIN, -3949, 107, 8296, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_BLUE_COIN, -4526, 107, 7251, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_BLUE_COIN, -4507, 107, 6515, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_BLUE_COIN, -4922, 113, 8356, 0, 0, 0, 0x00000000, bhvRedCoin),
