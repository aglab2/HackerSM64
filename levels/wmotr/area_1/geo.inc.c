...
const GeoLayout wmotr_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wmotr_dl_DL_wmotr_1_0xe02d3b0_Obj_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, wmotr_dl_DL_wmotr_1_0xe0346a8_Obj_mesh_layer_4),
