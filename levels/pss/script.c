...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		WARP_NODE(0x30, LEVEL_PSS, 0x01, 0x20, WARP_NO_CHECKPOINT),
		WARP_NODE(0x31, LEVEL_PSS, 0x01, 0x21, WARP_NO_CHECKPOINT),
		WARP_NODE(0x32, LEVEL_PSS, 0x01, 0x22, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf3, LEVEL_PSS, 0x01, 0x23, WARP_NO_CHECKPOINT),
		WARP_NODE(0x20, LEVEL_PSS, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x21, LEVEL_PSS, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x22, LEVEL_PSS, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x23, LEVEL_PSS, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 4786, 14329, 3144, 0, 0, 0, (0x20 << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, 11847, 9481, 9413, 0, 180, 0, (0x21 << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, 1820, 6481, 4576, 0, 270, 0, (0x22 << 16), bhvAirborneDeathWarp),
		OBJECT(MODEL_NONE, -4535, 3086, 2621, 0, 45, 0, (0x23 << 16), bhvAirborneDeathWarp),
