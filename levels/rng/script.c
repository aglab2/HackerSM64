...
const LevelScript level_rng_entry[] = {
	...
	LOAD_MODEL_FROM_DL(MODEL_AGLAB_RNG_CHECKPOINT, DL_Checkpoint_Flag_MOP_0x606660, LAYER_OPAQUE), 
	...
	AREA(7, rng_area_7),
		...
		OBJECT(MODEL_RED_COIN, -5838, 2081, 10097, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 134, 2081, 10241, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 6235, 2081, 10131, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 6389, 2081, 4086, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 6226, 2081, -1985, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 190, 2081, -2120, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -5846, 2081, -2031, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_NONE, 233, 2325, 4052, 0, 0, 0, (6 << 24), bhvHiddenRedCoinStar),
