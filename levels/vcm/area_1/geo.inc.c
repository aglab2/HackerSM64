...
const GeoLayout vcm_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT_DECAL, 9722, -2398, -411, 0, -180, 0, vcm_dl_pj74_vc_007_mesh_layer_6),
		GEO_DISPLAY_LIST(LAYER_ALPHA, vcm_dl_pj74_vc_008_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
