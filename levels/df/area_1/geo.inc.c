...
const GeoLayout df_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, df_dl_Dice_Fortress_mesh_layer_4),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, df_dl_Dice_Fortress_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, df_dl_Dice_Fortress_mesh_layer_5),
		GEO_CLOSE_NODE(),
		...
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, 90, 0, 0, df_dl_Dice_Fortress_005_mesh_layer_6),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout df_area_1[] = {
