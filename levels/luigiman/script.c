...
const LevelScript level_luigiman_entry[] = {
	...
	AREA(1, luigiman_area_1),
		...
		WARP_NODE(0x33, LEVEL_LUIGIMAN, 0x01, 0x33, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -4265, 307, 9251, 0, -45, 0, 0x00000000, bhvLuigmanRespawn),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 5926, 754, 13232, 0, 0, 0, 0x00060000, bhvExclamationBox),
		OBJECT(MODEL_NONE, 4523, 301, 11601, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		...
		OBJECT(MODEL_NONE, 7758, 2739, 454, 0, 0, 0, 0x00330000, bhvDeathWarp),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_SPACE),
