...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 1030, 3042, 1955, 0, -125, 0, (0 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 10364, 2530, 7813, 0, 0, 0, (2 << 16), bhvCoinFormation),
		...
		MARIO_POS(0x01, 0, -8559, 8722, 3126),
