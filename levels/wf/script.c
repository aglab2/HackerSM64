...
const LevelScript level_wf_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_RR_DONUT_PLATFORM, iceblock_geo),
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_RR_DONUT_PLATFORM, 5512, 4109, 4963, 0, 230, 0, 0, bhvIceBlockMini),
		OBJECT(MODEL_BLUE_COIN, 2301, 1031, 451, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 2178, 1972, 4438, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 1899, 1880, 3746, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 2276, 1031, 1388, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 1719, 1239, 2176, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 1392, 1623, 3182, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 2963, 1972, 4928, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, 2612, 656, 283, 0, -30, 0, (0 << 16), bhvHiddenBlueCoin),
		...
		OBJECT(MODEL_CHUCKYA, -6084, 2752, -10030, 0, -21, 0, 0x00000000, bhvChuckya),
		OBJECT(MODEL_BLACK_BOBOMB, -10166, 5820, 4775, 0, -21, 0, 0x00000000, bhvBobomb),
		...
		OBJECT(MODEL_RR_DONUT_PLATFORM, 1550, 3312, 66, 0, 0, 0, 0, bhvIceBlock),
		...
		OBJECT(MODEL_NONE, 7186, 4233, 4104, 0, -34, 0, (COIN_FORMATION_FLAG_ARROW << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -262, 2752, -3937, 0, -91, 0, (0 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, 619, 2759, 3080, 0, -85, 0, (0 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 10364, 2851, 7813, 0, -180, 0, (6 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_SL_SNOW_TREE, 8517, 1883, 7389, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_SL_SNOW_TREE, 6730, 1883, 7291, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_SL_SNOW_TREE, 5747, 1883, 6460, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_SL_SNOW_TREE, 8761, 1883, 4874, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_SL_SNOW_TREE, 7637, 1883, 4934, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_SL_SNOW_TREE, 6414, 1883, 5307, 0, 0, 0, 0x00000000, bhvTree),
		...
		OBJECT(MODEL_RR_DONUT_PLATFORM, 6543, 2915, -1737, 0, 135, 0, 0x00000000, bhvIceBlock),
