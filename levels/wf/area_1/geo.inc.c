...
const GeoLayout wf_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, 90, 0, 0, wf_dl_c2_mesh_layer_6),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_c2_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, wf_dl_c2_001_mesh_layer_4),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, wf_dl_c2_002_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
