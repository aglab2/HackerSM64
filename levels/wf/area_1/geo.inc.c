...
const GeoLayout wf_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, wf_dl__bg_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_b3_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_e5_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, wf_dl_e5_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, wf_dl_zbg_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
