...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 283, -142, 2350, 90, 0, 0, bob_dl_flameboost_mesh_layer_1),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4297, -531, 1469, 90, 0, 0, bob_dl_nostand_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 4297, -531, 1469, 90, 0, 0, bob_dl_nostand_001_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 0, 432, 1791, 90, 0, 0, bob_dl_slopewall_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
