...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_flameboost_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_flameboost_001_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_nostand_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_nostand_001_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_slopewall_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
