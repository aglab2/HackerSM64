...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT_WITH_ACTS(0, 2334, 1184, 1597, 0, 0, 0, 0x0, bhvHiddenStarTrigger, ACT_6),
		OBJECT_WITH_ACTS(0, -4431, 1921, -2467, 0, 0, 0, 0x0, bhvHiddenStarTrigger, ACT_6),
		OBJECT_WITH_ACTS(0, -3081, 1501, -3377, 0, 0, 0, 0x0, bhvHiddenStarTrigger, ACT_6),
		OBJECT_WITH_ACTS(0, -3220, 2783, 2560, 0, 0, 0, 0x0, bhvHiddenStarTrigger, ACT_6),
		OBJECT_WITH_ACTS(0, 2599, 1380, -2682, 0, 0, 0, 0x0, bhvHiddenStarTrigger, ACT_6),
		OBJECT_WITH_ACTS(86, -3094, 1455, -3325, 0, 90, 0, 0x0, bhvKingBobomb, ACT_1),
		OBJECT_WITH_ACTS(116, 2602, 1350, -2677, 0, 0, 0, 0x0, bhvOneCoin, ACT_6),
		OBJECT_WITH_ACTS(116, -3072, 1500, -3374, 0, 0, 0, 0x0, bhvOneCoin, ACT_6),
		OBJECT_WITH_ACTS(116, -3220, 2783, 2560, 0, 0, 0, 0x0, bhvOneCoin, ACT_6),
		OBJECT_WITH_ACTS(116, -4431, 1920, -2457, 0, 0, 0, 0x0, bhvOneCoin, ACT_6),
		OBJECT_WITH_ACTS(116, 2322, 1170, 1588, 0, 0, 0, 0x0, bhvOneCoin, ACT_6),
