...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		WARP_NODE(0x0A, LEVEL_CASTLE_GROUNDS, 0x01, 0x25, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_CASTLE_GROUNDS, 0x01, 0x55, WARP_NO_CHECKPOINT),
		WARP_NODE(0x3A, LEVEL_BOB, 0x01, 0x3B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x3B, LEVEL_BOB, 0x01, 0x3A, WARP_NO_CHECKPOINT),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, 0, -78, 4571, 0, -180, 0, (0x3A << 16), bhvFadingWarp, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_NONE, 93, 2325, 786, 0, 0, 0, (0x3B << 16), bhvFadingWarp, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_NONE, 0, -78, 4571, 0, -180, 0, (0x3A << 16), bhvSparkler, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_NONE, 93, 2325, 786, 0, 0, 0, (0x3B << 16), bhvSparkler, ACT_3 | ACT_4 | ACT_5 | ACT_6),
		...
		OBJECT(MODEL_NONE, -580, -3191, -11012, 0, 90, 0, ((COIN_FORMATION_FLAG_ARROW) << 16) | (0), bhvCoinFormation),
