...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 7196, -607, -12663, 0, 0, 0, (8 << 16), bhvHole),
		OBJECT(MODEL_NONE, 2102, -1325, 12086, 0, 0, 0, (7 << 16), bhvHole),
		...
		OBJECT(MODEL_NONE, -3022, -543, -11171, 0, 0, 0, (5 << 16), bhvInit),
		OBJECT(MODEL_NONE, -8857, -860, 12488, 0, 0, 0, (6 << 16), bhvInit),
		OBJECT(MODEL_NONE, 7194, -903, -6991, 0, 0, 0, (8 << 16), bhvInit),
		OBJECT(MODEL_NONE, 2081, -1160, 14618, 0, 0, 0, (7 << 16), bhvInit),
