...
const GeoLayout bob_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 15291, -3491, 3071, bob_dl_bg_001_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4287, -82, 6950, bob_dl_c1_a2_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 4287, -82, 6950, bob_dl_c1_a2_001_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
