...
const GeoLayout bob_area_4_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 644, -2320, -32041, bob_dl__bg_002_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -14499, -4338, -29109, bob_dl_level_02_001_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, bob_dl_level_02_001_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -14499, -4338, -29109),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 644, -2320, -32041, bob_dl_level_02_008_mesh_layer_1),
		GEO_OPEN_NODE(),
