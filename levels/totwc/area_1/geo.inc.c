...
const GeoLayout totwc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, totwc_dl_DL_totwc_1_0xe013030_Obj_mesh_layer_1),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, totwc_dl_DL_totwc_1_0xe01a6f0_Obj_mesh_layer_4),
