...
const GeoLayout totwc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, totwc_dl__bg_002_mesh_layer_6),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, totwc_dl__bg_002_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, totwc_dl_s2_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, totwc_dl_s2_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, totwc_dl_s2_001_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, totwc_dl_s2_004_mesh_layer_5),
...
const GeoLayout totwc_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE_INTER, totwc_dl_material_revert_render_settings),
