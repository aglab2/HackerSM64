...
const LevelScript level_totwc_entry[] = {
	...
	AREA(1, totwc_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 1591, 5878, -9869, 0, 0, 0, (2 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_HEAVE_HO, 5276, 5021, -4163, 0, -39, 0, 0x00000000, bhvHeaveHo),
		...
		MARIO_POS(0x01, 0, 4430, -994, 12118),
		OBJECT(MODEL_NONE, 4447, -994, 12143, 0, 0, 0, (0xa << 16), bhvInstantActiveWarp),
		...
		OBJECT(MODEL_SSL_PALM_TREE, 5231, 1892, 5255, 0, 0, 0, 0x00000000, bhvTree),
		OBJECT(MODEL_SSL_PALM_TREE, 3935, 1892, 5664, 0, 0, 0, 0x00000000, bhvTree),
