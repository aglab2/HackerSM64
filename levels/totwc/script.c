...
const LevelScript level_totwc_entry[] = {
	...
	AREA(1, totwc_area_1),
		...
		WARP_NODE(0xf3, LEVEL_TOTWC, 1, 0x31, WARP_NO_CHECKPOINT),
		WARP_NODE(0x31, LEVEL_CASTLE, 2, 0x62, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 4447, -994 + 200, 12143, 0, -94, 0, (0xa << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_NONE, 4447, -794, 12143, 0, -94, 0, (0x31 << 16), bhvDeathWarp),
