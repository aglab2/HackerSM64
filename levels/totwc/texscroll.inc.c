void scroll_totwc_dl_s2_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 97;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(totwc_dl_s2_mesh_layer_1_vtx_0);
...
void scroll_totwc_dl_s2_003_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 9;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(totwc_dl_s2_003_mesh_layer_1_vtx_0);
...
void scroll_totwc() {
	scroll_totwc_dl_s2_mesh_layer_1_vtx_0();
	scroll_totwc_dl_s2_mesh_layer_5_vtx_0();
	scroll_totwc_dl_s2_003_mesh_layer_1_vtx_0();
}
