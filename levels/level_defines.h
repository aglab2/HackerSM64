...
DEFINE_LEVEL("COURSE 5 BBH", LEVEL_BBH, COURSE_BBH, bbh, cave, 20000, 0x00, 0x00, 0x00, sDynBbh, sCamBBH) 
...
DEFINE_LEVEL("COURSE 1 BOB", LEVEL_BOB, COURSE_BOB, bob, grass, 20000, 0x00, 0x00, 0x00, _, sCamBOB) 
...
DEFINE_LEVEL("COURSE 3 JRB", LEVEL_JRB, COURSE_JRB, jrb, fire, 20000, 0x00, 0x00, 0x00, sDynJrb, sCamJRB) 
...
DEFINE_LEVEL("BC3 BITS", LEVEL_BITS, COURSE_BITS, bits, grass, 20000, 0x00, 0x00, 0x00, _, sCamBitS) 
...
DEFINE_LEVEL("COURSE 2 WF", LEVEL_WF, COURSE_WF, wf, sky, 20000, 0x00, 0x00, 0x00, _, sCamWF) 
...
DEFINE_LEVEL("SIC P SEC SLID", LEVEL_PSS, COURSE_PSS, pss, machine, 20000, 0x00, 0x00, 0x00, _, sCamPSS) 
...
DEFINE_LEVEL("B BATTLE1", LEVEL_BOWSER_1, COURSE_BITDW, bowser_1, machine, 20000, 0x00, 0x00, 0x00, _, sCamBowser_1) 
DEFINE_LEVEL("SC2 WMOTR", LEVEL_WMOTR, COURSE_WMOTR, wmotr, fire, 20000, 0x00, 0x00, 0x00, _, sCamWMOtR) 
