...
DEFINE_LEVEL("COURSE 6 HMC", LEVEL_HMC, COURSE_HMC, hmc, fire, 20000, 0x00, 0x00, 0x00, sDynHmc, sCamHMC) 
...
DEFINE_LEVEL("COURSE 2 WF", LEVEL_WF, COURSE_WF, wf, generic, 20000, 0x00, 0x00, 0x00, _, sCamWF) 
DEFINE_LEVEL("END CAKE", LEVEL_ENDING, COURSE_CAKE_END, ending, generic, 20000, 0x00, 0x00, 0x00, _, _) 
DEFINE_LEVEL("OW3 C COURTYD", LEVEL_CASTLE_COURTYARD, COURSE_NONE, castle_courtyard, generic, 20000, 0x00, 0x00, 0x00, _, sCamCastleCourtyard) 
