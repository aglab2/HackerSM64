...
DEFINE_LEVEL("B BATTLE2", LEVEL_BOWSER_2, COURSE_BITFS, bowser_2, fire, 20000, 0x00, 0x00, 0x00, _, sCamBowser2) 
...
DEFINE_LEVEL("AB", LEVEL_AB, COURSE_AB, ab, generic, 20000, 0x00, 0x00, 0x00, _, sCamAb) 
DEFINE_LEVEL("DF", LEVEL_DF, COURSE_DF, df, generic, 20000, 0x00, 0x00, 0x00, _, sCamDf) 
DEFINE_LEVEL("MF", LEVEL_MF, COURSE_MF, mf, generic, 20000, 0x00, 0x00, 0x00, _, sCamMf) 
DEFINE_LEVEL("MTC", LEVEL_MTC, COURSE_MTC, mtc, generic, 20000, 0x00, 0x00, 0x00, _, sCamMtc) 
...
DEFINE_LEVEL("ROVERT", LEVEL_ROVERT, COURSE_ROVERT, rovert, generic, 20000, 0x00, 0x00, 0x00, _, sCamRovert) 
DEFINE_LEVEL("RNG", LEVEL_RNG, COURSE_RNG, rng, generic, 20000, 0x00, 0x00, 0x00, _, sCamRng) 
DEFINE_LEVEL("LUIGIMAN", LEVEL_LUIGIMAN, COURSE_LUIGIMAN, luigiman, generic, 20000, 0x00, 0x00, 0x00, _, sCamLuigiman) 
DEFINE_LEVEL("DAN", LEVEL_DAN, COURSE_DAN, Dan, generic, 20000, 0x00, 0x00, 0x00, _, sCamDan) 
DEFINE_LEVEL("SPHERE", LEVEL_SPHERE, COURSE_SPHERE, sphere, generic, 20000, 0x00, 0x00, 0x00, _, sCamSphere) 
