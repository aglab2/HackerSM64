...
const GeoLayout bowser_1_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bowser_1_dl_f2_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, bowser_1_dl_f2_mesh_layer_2),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bowser_1_dl_f2_001_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bowser_1_dl_f2_002_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout bowser_1_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, bowser_1_dl_material_revert_render_settings),
