...
const GeoLayout lll_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, lll_dl_ending_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, lll_dl_ending_mesh_layer_2),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_INTER, lll_dl_ending_mesh_layer_3),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, lll_dl_ending_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, lll_dl_ending_001_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout lll_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE_INTER, lll_dl_material_revert_render_settings),
