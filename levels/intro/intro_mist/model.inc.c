...
// 0x03000000
static const Vtx intro_mist_seg3_vertex_03000000[] = {
...
// 0x03000040
static const Vtx intro_mist_seg3_vertex_03000040[] = {
...
// 0x03000080
ALIGNED8 static const Texture intro_mist_seg3_texture_03000080[] = {
#include "actors/mist/mist.ia16.inc.c"
};

// 0x03000880 - 0x03000920
const Gfx intro_mist_seg3_dl_03000880[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetCombineMode(G_CC_MODULATEIFADEA, G_CC_MODULATEIFADEA),
    gsDPLoadTextureBlock(intro_mist_seg3_texture_03000080, G_IM_FMT_IA, G_IM_SIZ_16b, 32, 32, 0, G_TX_CLAMP, G_TX_CLAMP, 5, 5, G_TX_NOLOD, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPVertex(intro_mist_seg3_vertex_03000000, 4, 0),
