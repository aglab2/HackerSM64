...
const LevelScript level_mf_entry[] = {
	...
	AREA(1, mf_area_1),
		...
		WARP_NODE(0x21, LEVEL_MF, 1, 0x20, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -317, -2347, -4762, 0, 0, 0, (0x21 << 16), bhvFadingWarp),
		OBJECT(MODEL_NONE, -317, -2347, -4762, 0, 0, 0, 0, bhvSparkler),
		OBJECT(MODEL_NONE, -2215, 197, -5515, 0, 0, 0, (0x20 << 16), bhvFadingWarp),
