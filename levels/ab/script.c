...
const LevelScript level_ab_entry[] = {
	...
	AREA(1, ab_area_1),
		...
		OBJECT(MODEL_NONE, -5084, 134, -4796, 0, 150, 0, (0xa << 16), bhvInstantActiveWarp),
		...
		OBJECT(MODEL_RED_COIN, -4755, -48, -5480, 0, -2, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_RED_COIN, -4838, -1361, -8885, 0, -2, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -3730, -707, -6514, 0, -2, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_PURPLE_SWITCH, 478, -2576, -7746, 0, 16, 0, 0x00000000, bhvAbPurpleSwitch),
