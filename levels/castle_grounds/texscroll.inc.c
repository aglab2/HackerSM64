...
void scroll_castle_grounds_dl_castle_011_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 4;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(castle_grounds_dl_castle_011_mesh_layer_5_vtx_0);
...
void scroll_castle_grounds() {
	...
	scroll_castle_grounds_dl_castle_011_mesh_layer_5_vtx_0();
}
