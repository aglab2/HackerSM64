...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_NONE, 780, -2681, 6129, 0, 0, 0, (0x11 << 16), bhvCoinFormation),
		OBJECT(MODEL_FIREBALL, 3889, 5595, 1630, 0, 0, 0, 0x00000000, bhvDeathFireball),
		MARIO_POS(0x01, 0, 759, -4705, 8613),
		OBJECT(MODEL_NONE, 757, -4705, 8578, 0, 0, 0, (0xf1 << 16), bhvDeathWarp),
