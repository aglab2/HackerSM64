...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_BLACK_BOBOMB, 2385, 405, -688, 0, 157, 0, (0 << 24) | (4 << 16), bhvPlayer),
		OBJECT(MODEL_BLACK_BOBOMB, 2245, 405, -771, 0, 152, 0, (0 << 24) | (3 << 16), bhvPlayer),
		OBJECT(MODEL_BLACK_BOBOMB, 2108, 405, -853, 0, 154, 0, (0 << 24) | (2 << 16), bhvPlayer),
		OBJECT(MODEL_BLACK_BOBOMB, 1972, 405, -935, 0, 151, 0, (0 << 24) | (1 << 16), bhvPlayer),
		OBJECT(MODEL_BLACK_BOBOMB, 1841, 405, -1017, 0, 153, 0, (0 << 24) | (0 << 16), bhvPlayer),
