...
const GeoLayout castle_grounds_area_2_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE_DECAL, 1970, -844, 154, 90, 0, 0, castle_grounds_dl_ow1_003_mesh_layer_2),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_ow1_003_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_ow1_003_mesh_layer_4),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
