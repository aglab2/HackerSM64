...
const GeoLayout cotmc_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, cotmc_dl_DL_cotmc_1_0xe02d9a0_Obj_mesh_layer_1),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, cotmc_dl_DL_cotmc_1_0xe034b98_Obj_mesh_layer_4),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, cotmc_dl_DL_cotmc_1_0xe035048_Obj_mesh_layer_4),
