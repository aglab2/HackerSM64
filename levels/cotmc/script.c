...
const LevelScript level_cotmc_entry[] = {
	...
	AREA(1, cotmc_area_1),
		...
		OBJECT(MODEL_NONE, 2679, 2189, 1645, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		...
		OBJECT(MODEL_SSL_PALM_TREE, 1598, 1848, 2032, 0, 0, 0, 0x00000000, bhvTree),
		...
		OBJECT(MODEL_SSL_PALM_TREE, 2310, 1848, 1676, 0, 0, 0, 0x00000000, bhvTree),
		...
		OBJECT(MODEL_SSL_PALM_TREE, 6930, 1835, 7959, 0, 0, 0, 0x00000000, bhvTree),
