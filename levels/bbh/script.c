...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		WARP_NODE(0x30, LEVEL_BBH, 0x01, 0x31, WARP_NO_CHECKPOINT),
		WARP_NODE(0x31, LEVEL_BBH, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x32, LEVEL_BBH, 0x01, 0x33, WARP_NO_CHECKPOINT),
		WARP_NODE(0x33, LEVEL_BBH, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf3, LEVEL_BBH, 0x01, 0x34, WARP_NO_CHECKPOINT),
		WARP_NODE(0x34, LEVEL_BBH, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -4949, -213, 11004, 0, -40, 0, (0x31 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -1073, -317, 10521, 0, 90, 0, (0x33 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -2050, -317, 9099, 0, 180, 0, (0x34 << 16), bhvDeathWarp),
		OBJECT(MODEL_NONE, -5393, 655, 6745, 0, 92, 0, (0x34 << 16), bhvRecoveryHeart),
