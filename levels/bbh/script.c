...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, -2501, -685, 10855, 0, 0, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -14848, 2669, 6019, 0, -91, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -15221, 2669, 5936, 0, 89, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 460, -685, 14130, 0, 0, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -2770, -685, 10913, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		...
		MARIO_POS(0x01, 90, -8960, -594, 13973),
		OBJECT(MODEL_NONE, 487, -685, 14126, 0, 0, 0, (0xa << 16), bhvInstantActiveWarp),
		...
		OBJECT_WITH_ACTS(MODEL_WIGGLER_HEAD, -3138, -685, 10450, 0, 0, 0, 0x00000000, bhvWigglerHead, ACT_6),
