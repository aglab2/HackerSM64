...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_BLUE_COIN_SWITCH, -2436, -685, 12696, 0, 92, 0, 0x00000000, bhvBlueCoinSwitch, ACT_1 | ACT_2 | ACT_3 | ACT_4),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, -2172, -685, 12749, 0, -90, 0, (4 << 16), bhvCoinFormation, ACT_5),
		...
		OBJECT_WITH_ACTS(MODEL_RED_COIN, 11025, -2036, -1540, 0, 0, 0, 0x00000000, bhvRedCoin, ACT_1 | ACT_2 | ACT_3 | ACT_4),
		OBJECT_WITH_ACTS(MODEL_RED_COIN, 8117, -2036, -626, 0, 0, 0, 0x00000000, bhvRedCoin, ACT_1 | ACT_2 | ACT_3 | ACT_4),
		OBJECT_WITH_ACTS(MODEL_RED_COIN, 8683, -2036, 759, 0, 0, 0, 0x00000000, bhvRedCoin, ACT_1 | ACT_2 | ACT_3 | ACT_4),
		OBJECT_WITH_ACTS(MODEL_RED_COIN, 11929, -2036, 99, 0, 0, 0, 0x00000000, bhvRedCoin, ACT_1 | ACT_2 | ACT_3 | ACT_4),
		OBJECT_WITH_ACTS(MODEL_RED_COIN, 10918, -2036, 1510, 0, 0, 0, 0x00000000, bhvRedCoin, ACT_1 | ACT_2 | ACT_3 | ACT_4),
		...
		OBJECT(MODEL_NONE, 7430, -1869, -3067, 0, 0, 0, (3 << 24), bhvHiddenRedCoinStar),
