...
const GeoLayout bitdw_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, bitdw_dl_DL_bitdw_1_0xe033b80_Obj_mesh_layer_1),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, bitdw_dl_DL_bitdw_1_0xe03a448_Obj_mesh_layer_4),
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, bitdw_dl_DL_bitdw_1_0xe03a6a8_Obj_mesh_layer_5),
