...
const GeoLayout vcutm_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, vcutm_dl_DL_vcutm_1_0xe02d1d0_Obj_mesh_layer_1),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, vcutm_dl_DL_vcutm_1_0xe034260_Obj_mesh_layer_4),
