...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		WARP_NODE(0x10, LEVEL_CCM, 0x01, 0x11, WARP_NO_CHECKPOINT),
		WARP_NODE(0x11, LEVEL_BOB, 0x01, 0x41, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -1057, -193, -6264, 0, 0, 0, 0x00000000, bhvSparkler),
		OBJECT(MODEL_NONE, -1057, -173, -6264, 0, 0, 0, (0x10 << 16), bhvFadingWarp),
		OBJECT(MODEL_NONE, -926, 921, -5635, 0, 0, 0, (0x11 << 16), bhvFadingWarp),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 5730, -337, -1223, 0, 0, 0, 0x00000000, bhvHiddenObject),
		...
		OBJECT(MODEL_NONE, 3253, -4, 1704, 0, 90, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -1220, 922, -6913, 0, 161, 0, (20 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -2392, 17, -485, 0, 0, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -1087, -409, -2564, 0, 0, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -5645, 991, -4929, 0, 0, 0, (17 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -6598, 525, -4901, 0, 90, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_NONE, 5117, -1169, -1127, 0, 0, 0, (17 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, -371, 1593, -4064, 0, 0, 0, (6 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, -3520, 809, -5031, 0, 0, 0, (6 << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_HEAVE_HO, -2843, -480, -1139, 0, 0, 0, (0 << 16), bhvHeaveHo),
		MARIO_POS(0x01, -180, -1092, 6095, 7707),
		OBJECT(MODEL_WOODEN_SIGNPOST, 3243, -4, 1697, 0, -100, 0, (8 << 16), bhvMessagePanel),
		OBJECT(MODEL_WOODEN_SIGNPOST, -721, 571, -7414, 0, -19, 0, (15 << 16), bhvMessagePanel),
