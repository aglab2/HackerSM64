...
const GeoLayout ccm_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 12692, 2166, -6331, 90, 0, 0, ccm_dl_c4_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, ccm_dl_c4_mesh_layer_4),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_TRANSPARENT, 12692, 0, -6331, 90, 0, 0, ccm_dl_water_thing_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
