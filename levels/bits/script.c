...
const LevelScript level_bits_entry[] = {
	...
	AREA(1, bits_area_1),
		...
		WARP_NODE(0xf3, LEVEL_BITS, 0x01, 0x33, WARP_NO_CHECKPOINT),
		WARP_NODE(0x33, LEVEL_CASTLE_COURTYARD, 0x01, 0x33, WARP_NO_CHECKPOINT),
		WARP_NODE(0xb, LEVEL_BOWSER_3, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 3328, -144, 2984, 30, 180, 0, (0x33 << 16), bhvDeathWarp),
		...
		OBJECT(MODEL_NONE, -131, 4462, -13476, 0, -180, 0, (0xf1 << 16), bhvDeathWarp),
