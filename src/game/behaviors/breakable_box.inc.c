...
void bhv_breakable_box_init(void)
{
    obj_scale(o, 1.5f);
}
...
void bhv_breakable_box_loop(void) {
    ...
    f32 d;
    cur_obj_find_nearest_object_with_behavior(bhvSmallPenguin, &d);
    if (cur_obj_was_attacked_or_ground_pounded() || (d < 400.f && o->oPosY < 100.f)) {
