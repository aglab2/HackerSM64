...
void reset_camera(struct Camera *c) {
    ...
    sCSideButtonYaw = 0;
    s8DirModeBaseYaw = 0;
    s8DirModeYawOffset = gCurrLevelNum == LEVEL_CASTLE_GROUNDS ? 0x8000 : 0;
...
void cutscene_aglab_outsides_cs(struct Camera *c) {
...
struct Cutscene sCutsceneAglabOutsides[] = {
    { cutscene_aglab_outsides_cs, CUTSCENE_LOOP },
};
...
struct Cutscene sCutsceneAglabCastleWalls[] = {
    { cutscene_aglab_castle_walls, CUTSCENE_LOOP },
};

void cutscene_aglab_water(struct Camera *c) {
    cutscene_event(cutscene_reset_spline, c, 0, 0);
    c->focus[0] = 3897.f;
    c->focus[1] = -421.f;
    c->focus[2] = 2810.f;
...
struct Cutscene sCutsceneAglabWater[] = {
    { cutscene_aglab_water, CUTSCENE_LOOP },
};

void cutscene_aglab_bridge(struct Camera *c) {
    cutscene_event(cutscene_reset_spline, c, 0, 0);
    c->focus[0] = 82.f;
    c->focus[1] = 455.f;
    c->focus[2] = 904.f;
...
struct Cutscene sCutsceneAglabBridge[] = {
...
struct CutsceneSplinePoint gCSAglabTowersFocus[] = {
    { 0, 40, { 3747.f, 2546.f, 6325.f } }, 
    { 1, 40, { 3747.f, 2546.f, 6325.f } }, 
    { 2, 40, { 3110.f, 1046.f, 2727.f } },
    { 3, 40, { -3254.f, 2546.f, 2876.f } },
    { 4, 30, { -3934.f, 2546.f, 6317.f } },
    { 5, 30, { -5934.f, 2546.f, 6817.f } },
