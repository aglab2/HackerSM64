...
enum Cutscenes {
    ...
    CUTSCENE_AGLAB_OUTSIDES,
    CUTSCENE_AGLAB_CASTLE_VIEW,
    CUTSCENE_AGLAB_CASTLE_VIEW2,
    CUTSCENE_AGLAB_CASTLE_WALLS,
    CUTSCENE_AGLAB_WATER,
    CUTSCENE_AGLAB_BRIDGE,
    CUTSCENE_AGLAB_WINDOW,
    CUTSCENE_AGLAB_FRAME,
    CUTSCENE_AGLAB_ROOF,
    CUTSCENE_AGLAB_TOWERS,
    CUTSCENE_AGLAB_MAIN,
    CUTSCENE_AGLAB_BG,

    CUTSCENE_AGLAB_WATER_SHOWCASE,
    CUTSCENE_AGLAB_BRIDGE_SHOWCASE,
    CUTSCENE_AGLAB_WINDOW_SHOWCASE,
    CUTSCENE_AGLAB_TOWERS_SHOWCASE,
    CUTSCENE_AGLAB_MAIN_SHOWCASE,
};
