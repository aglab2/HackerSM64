...
u8 sDialogSpeaker[] = {
    ...
    /* 3*/ AGLAB_CASTLE, AGLAB_CASTLE2, AGLAB_SURROUNDINGS, AGLAB_WALLS, AGLAB_MOAT, AGLAB_BRIDGE, AGLAB_WINDOW, AGLAB_PORTRAIT, AGLAB_ROOF, AGLAB_SIDETOWERS,
    /* 4*/ AGLAB_MAIN, AGLAB_BG, AGLAB_DONE,     _,     _,     _,     _,     BOMB,  _,     _,
    /* 5*/ AGLAB_PEACH,     _,     _,     _,     _,     TUXIE, TUXIE, TUXIE, TUXIE, TUXIE,
...
s32 sDialogSpeakerVoice[] = {
    ...
    SOUND_AGLAB_BRIDGE,
    SOUND_AGLAB_DONE,
    SOUND_AGLAB_JAMS_DISASTER,
    SOUND_AGLAB_JAMS_DONE,
    SOUND_AGLAB_JAMS_DUALITY,
    SOUND_AGLAB_JAMS_EVOLUTION,
    SOUND_AGLAB_JAMS_ONE,
    SOUND_AGLAB_JAMS_SHELL,
    SOUND_AGLAB_JAM0,
    SOUND_AGLAB_MAIN,
    SOUND_AGLAB_MOAT,
    SOUND_AGLAB_PEACH,
