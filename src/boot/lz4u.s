##############################################
#  lz4u - Fast decompressor in assembly
...
#define off_nibble  $t4
    ...
    .section .text.decompress_lz4u_full_fast
	.p2align 5
    .globl decompress_lz4u_full_fast 
    .func decompress_lz4u_full_fast
    .set at
    .set noreorder

decompress_lz4u_full_fast:
    addiu $sp, $sp, -0x40
    sw $ra, 0x14($sp)
    sw $s0, 0x18($sp)
    sw $s1, 0x1c($sp)
